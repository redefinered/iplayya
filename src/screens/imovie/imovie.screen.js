...
const ImovieScreen = ({ error, movies, getMoviesAction, paginatorInfo: { limit, pageNumber } }) => {
  React.useEffect(() => {
    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={{ marginBottom: 30 }}>
          <ContentWrap>
            <Text style={{ fontSize: 16, lineHeight: 22, marginBottom: 15 }}>Featured Movies</Text>
          </ContentWrap>
