...
export default class NotifService {
  ...
  //     configuration = Object.assign(configuration, { repeatType: 'minute', repeatTime: 5 });
  //   }
  ...
  //       /* iOS and Android properties */
  //       // id: this.lastId, // (optional) Valid unique 32 bit integer specified as string. default: Autogenerated Unique ID
  //       id: `${id}_ios_showstart` || this.lastId,
  //       title: channelName || 'Scheduled Notification', // (optional)
  //       message: description || 'My Notification Message', // (required)
  //       // userInfo: { screen: 'home' }, // (optional) default: {} (using null throws a JSON value '<null>' error)
  //       userInfo: { id, channelId },
  ...
  cancelNotif(id) {
    ...
    // console.log({ id: `1${id}` });
    // console.log({ id: `2${id}` });
    // PushNotification.cancelLocalNotifications({ id: `1${id}` });
