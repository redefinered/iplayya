...
export default class NotifService {
  ...
  scheduleNotif({ id, channelId, channelName, program }, soundName) {
    ...
    PushNotification.localNotificationSchedule({
      date: moment(datetime).subtract(5, 'minutes'), // should be the time of the program minus 5 minutes
  ...
  cancelNotif(id) {
    PushNotification.cancelLocalNotifications({ id: `${id}_before` });
